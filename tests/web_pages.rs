...
fn web_manual_device_script_records_real_browser_device_evidence() {
    ...
    for required in [
        ...
        "evaluateManualVisualState",
        "manualVisualStateLooksClean",
        "manualVisualStateShowsResize",
        "afterLargeVisualInspection",
        "orbifoldTextAuditIssueCount",
        ...
        "Release the same MIDI note",
        "midiStateIsNoteOn",
        "midiStateIsNoteOff",
        "manualBrowserFileFlows",
        "beforeBrowserFileFlows",
        "afterBrowserFileFlowsBeforeReload",
        "pickBrowserFileFlowEvidence",
        "navigationType",
        "timeOrigin",
        ...
        "pickShortcutParityEvidence",
        "pickPianoRollParityEvidence",
        "requiredWorkflows",
        "browserFileFlows",
        "shortcutParity",
        "pianoRollParity",
...
fn web_manual_report_validator_requires_real_device_evidence() {
    ...
    for required in [
        ...
        "manualBrowserFileFlows.scalaPath",
        "manualBrowserFileFlows.assetCount",
        "manualShortcutParity.after.lastAction",
        ...
        "midiInputCount",
        "connectedMidiInput",
        "states.duringRealMidiNote",
        "lastMidiVelocity",
        "manualRealMidiInput.noteOn",
        ...
        "beforeNoteCount",
        "afterNoteCount",
        "manualRealMidiInput evidence should show a changed MIDI note-on event",
        "should show a MIDI note-on with velocity",
        "should show a matching MIDI note-off",
        "requiredClickCounts",
        "audioTestA4",
        "midiRefresh",
    ...
    for required in [
        ...
        "manualBrowserFileFlows evidence should show a browser reload checkpoint",
        "manualBrowserFileFlows.after.navigationType expected",
...
fn web_smoke_script_checks_headless_runtime_readiness() {
    ...
    for required in [
        ...
        "document.body.dataset.orbifoldLastMidiVelocity",
